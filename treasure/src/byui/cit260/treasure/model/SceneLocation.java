...
//        
//        //start point
//        location[0][0].setScene([sceneType.start.ordinal()]);
//        location[0][1].setScene([sceneType.beach.ordinal()]);
//        location[0][2].setScene([sceneType.ocean.ordinal()]);
//        location[0][3].setScene([sceneType.Island.ordinal()]);
